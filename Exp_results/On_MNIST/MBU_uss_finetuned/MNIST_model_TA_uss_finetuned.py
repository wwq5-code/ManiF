...
OUL_finetuned = [0.9925, 0.9918, 0.9915, 0.9913, 0.9919, 0.9909]
...
salun_acc = [0.9922, 0.9932,  0.9927, 0.9932, 0.9930, 0.9929]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.9915, 0.9908, 0.9902, 0.9894, 0.9886, 0.9882]
...
my_y_ticks = np.arange(98.4, 99.5, 0.2)
...
plt.savefig('MNIST_model_TA_uss_finetuned.pdf', format='pdf', dpi=200)
plt.show()