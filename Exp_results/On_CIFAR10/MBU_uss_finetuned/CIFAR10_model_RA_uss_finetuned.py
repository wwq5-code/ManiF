...
OUL = [0.9904, 0.9846, 0.9768, 0.9714, 0.9491, 0.9303]

OUL_finetuned = [0.9879, 0.9822, 0.9776, 0.9826, 0.9881, 0.9811]
...
plt.savefig('CIFAR10_model_RA_uss_finetuned.pdf', format='pdf', dpi=200)
plt.show()