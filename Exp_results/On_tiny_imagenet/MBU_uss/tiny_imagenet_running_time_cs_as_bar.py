...
unl_vbu = [0.181, 0.369 , 0.551 , 0.833 , 1.020, 1.2201]

unl_mbu = [0.29, 0.555, 1.057, 1.41, 1.62, 2.05]
unl_retrain = [3154, 3104, 3102, 3054, 3083, 3043]
salun = [1.39, 2.836, 4.13, 5.882, 7.1682, 9.0432]
...
plt.savefig('tiny_imagenet_running_time_cs_as_bar.pdf', format='pdf', dpi=200)
plt.show()
