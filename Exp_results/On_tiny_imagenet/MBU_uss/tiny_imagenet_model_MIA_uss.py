...
OUL = [0.545, 0.5449, 0.53833, 0.5437, 0.5540, 0.5525]

org_acc = [0.4950, 0.4950, 0.4950, 0.4950, 0.4950, 0.4950]

salun_acc = [0.5100, 0.5094,  0.5112, 0.5211, 0.52500, 0.531]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.5200, 0.5183, 0.5224, 0.5290, 0.5308, 0.543]
...
my_y_ticks = np.arange(50., 61, 2)
plt.yticks(my_y_ticks,fontsize=20)
plt.xlabel('$\it USS$' ,fontsize=20)

plt.xticks(x, labels, fontsize=20)
plt.title('On TinyImageNet',fontsize=24)
...
plt.savefig('tiny_imagenet_model_MIA_uss.pdf', format='pdf', dpi=200)
plt.show()