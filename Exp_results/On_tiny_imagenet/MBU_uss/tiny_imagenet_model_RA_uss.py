...
OUL = [0.8119, 0.8076, 0.7920, 0.7649, 0.7606, 0.7543]

org_acc = [0.8356, 0.8356, 0.8356, 0.8356, 0.8356, 0.8356]

salun_acc = [0.8193, 0.8240,  0.8238, 0.8237, 0.8228, 0.8292]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.8093, 0.7831, 0.7602, 0.7429, 0.7324, 0.7023]
...
my_y_ticks = np.arange(70.0, 86.9, 4)
...
plt.savefig('tiny_imagenet_model_RA_uss.pdf', format='pdf', dpi=200)
plt.show()