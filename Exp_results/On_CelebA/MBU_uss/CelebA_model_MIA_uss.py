...
OUL = [0.54500, 0.552, 0.5800, 0.5992, 0.6219, 0.6433]

org_acc = [0.4580, 0.4580, 0.4580, 0.4580, 0.4580, 0.4580]

salun_acc = [0.5450, 0.5274,  0.561, 0.5711, 0.569900, 0.5533]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.5600, 0.59831, 0.6132, 0.64990, 0.6683, 0.6893]
...
plt.savefig('CelebA_model_MIA_uss.pdf', format='pdf', dpi=200)
plt.show()