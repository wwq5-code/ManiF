...
unlearned_vib = prepare_unl(unlearning_loader, remaining_loader, vib, loss_fn, args, "no noise")
...
infer_acc = membership_inf_results(infer_model, unlearned_vib, unl_infer_data_loader, "after unl")


vib.eval()
acc_t = eva_vib(unlearned_vib, test_loader, args, name='on test dataset after unlearning', epoch=999)
acc_r = eva_vib(unlearned_vib, original_train_loader, args, name='on the remaining training after unlearning', epoch=999)
acc_ua = eva_vib(unlearned_vib, unlearning_loader, args, name='on the unlearning data after unlearning', epoch=999)
print("acc_ua:", 1 - acc_ua)
